...
| 4 | [`stata/04_test_contacts.do`](stata/04_test_contacts.do) | Contact-tracing sensitivity check |
| 5 | [`stata/05_fine_gray.do`](stata/05_fine_gray.do) | Main Fine–Gray competing-risks models (univariable + multivariable, adults and children) and cumulative incidence figures |
| 6 | [`stata/06_censoring_1y_2y_5y.do`](stata/06_censoring_1y_2y_5y.do) | Time-restricted sensitivity analyses (censoring at 1, 2, 5 years) |
| 7 | [`stata/07_coef_plot_children.do`](stata/07_coef_plot_children.do) | Coefficient plot for the children's model |
| 8 | [`R/survival_analysis.R`](R/survival_analysis.R) | Cumulative incidence curves, interval-specific incidence (≤3 months, 3–12 months, 1–2 years, 2–5 years, >5 years) with Poisson 95% CIs, and early- vs. late-recurrence partitioning |
